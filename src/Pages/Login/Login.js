  ...
  const handleGoogleSignIn = () => {
    ...
    return (
        <div className='bg-img'>
          ...
          <div className=''>
          <div className="lg:mx-96 rounded-lg mx-10 mt-16 py-16 px-16 mb-48">
            <div className="mb-3">
            ...
            <input
            type="email"
            onBlur={handleEmailChange} className="form-control bg-login border-b-2 block w-full px-3 py-1.5 focus:text-gray-700 focus:outline-none" id="exampleEmail0"placeholder="Enter email"/>
         </div>
            <div className="mb-3">
            <label for="" className="inline-block mb-2 text-gray-700 form-label"
            >Password </label
            ...
            <input
            type="password"
            onBlur={handlePasswordChange} className="form-control border-b-2 block w-full px-3 py-1.5 focus:text-gray-700 bg-login focus:outline-none" id="passsword"placeholder="Enter password"/>
         </div>
